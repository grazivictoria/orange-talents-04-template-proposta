package br.com.zupacademy.graziella.proposta.util.erros;
...
//    public ResponseEntity<ErroPadronizado> handleApiErroException(ResponseStatusException responseStatusException ) {
//        Collection<String> mensagens = new ArrayList<>();
